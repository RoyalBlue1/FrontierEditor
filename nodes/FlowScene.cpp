...
FlowScene::createConnection(Node& nodeIn, PortIndex portIndexIn, Node& nodeOut, PortIndex portIndexOut, TypeConverter const& converter)
{
...
void FlowScene::deleteConnection(Connection const& connection)
{
